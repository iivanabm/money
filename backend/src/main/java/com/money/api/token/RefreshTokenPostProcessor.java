...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken>{
	...
	public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter returnType, MediaType selectedContentType,
		...
		addRefreshTokenInCookie(refreshToken, httpServletRequest, httpServletResponse);
	...
	private void addRefreshTokenInCookie(String refreshToken, HttpServletRequest httpServletRequest,
